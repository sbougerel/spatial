...
/**
 *  \file   spatial_internal_mapping.hpp
 *  Contains the definition of the \ref mapping_minimum() and \ref
 *  mapping_maximum(). These definition are separated from the rest of the
 *  mapping_iterator iterface, since they are also used for general purpose by
 *  the trees.
 */
